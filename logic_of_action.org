...
|---------------------------|----------------------------------------|-----------------------------------------------------------------------------|-------------|
| Critical Success          | 3 or 4                                 | Exceptional performance that exceeds normal capabilities.                  | Narrate as particularly impressive or fortunate outcomes with additional beneficial effects. |
| Exceptional Success       | 5 or more below target number          | Above-average performance with potential minor additional benefits.        | May provide minor additional benefits as determined by the Game Master. |
| Marginal Success          | Equal to target or 1-4 below target    | Competent performance that achieves the goal without additional benefits.  | Standard success with no additional benefits. |
| Marginal Failure          | 1-4 above target number                | Near-success with some positive outcomes despite overall failure.          | May have some positive outcomes despite the overall failure, as determined by the Game Master. |
| Exceptional Failure       | 5 or more above target number          | Particularly poor performance with additional negative consequences.       | May have additional negative consequences beyond simply failing at the task. |
| Critical Failure          | 17 or 18                               | Catastrophic performance with significant negative effects.                | Narrate as particularly disastrous or unfortunate outcomes with significant negative effects. |
