...
When you need to determine how an NPC reacts to the players, consult this 2D table that cross-references the result of the social skill check with the 3d6 roll:
