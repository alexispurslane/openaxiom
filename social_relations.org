...
Klein, another player character, has a reputation score of 6 with the Coastal Merchants Guild and a reputation score of 3 with the Riverside Farmers, who are friendly to the Iron Mountain Dwarves. Since the Iron Mountain Dwarves are friendly to a faction Jax has encountered, his starting reputation with them is 3 (the lowest reputation score he has with a friendly faction).
#+END_QUOTE
...
Later in the session, Jax attempts to deceive a city guard about his identity. He rolls poorly and suffers a Critical Failure. His reputation with the city guard faction plummets from 5 to 1, making future interactions with guards more difficult.
#+END_QUOTE
...
Major events in the campaign can cause sweeping changes to reputation. For example, if a character is publicly revealed to have saved a city from disaster, their reputation with multiple factions might improve simultaneously. Conversely, being associated with a scandal or defeat could damage reputation across several factions at once.
